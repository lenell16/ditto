...
export function DurableChatPage() {
  ...
  return (
    <div className="mx-auto flex size-full max-w-4xl flex-col p-6">
      <div className="mb-4">
        <h1 className="text-lg font-medium">Durable Chat</h1>
        <p className="text-sm text-muted-foreground">
          Durable agent powered by Workflow SDK — retries LLM calls
          automatically and supports workflow observability
        </p>
      </div>
          ...
          <ConversationContent className="p-4">
            {messages.length === 0 ? (
              <ConversationEmptyState
                ...
                description="Type a message below to begin chatting with the durable agent"
              />
            ) : (
